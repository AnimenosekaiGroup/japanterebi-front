/**
 * This script is used to upscale the various channels using a high-quality real-time anime upscaling/denoising algorithms as GLSL (WebGL) shaders.
 * The original work comes from bloc97 on GitHub https://github.com/bloc97/Anime4K
 * This web version was made by NeuroWhAI on GitHub https://github.com/NeuroWhAI/Anime4K/tree/feat-web and got merged in Anime4K (master) in commit 88ab7e25aa5becbfd2d6c62b885d3df23eb21f55
 * The web version has been removed from the master branch as Anime4K v3 has been released (bloc97 cannot keep an old version of Anime4K just for the web version)
 * It got adapted to fit Japan Terebi and to improve performance and compatibility at the best I could
 * 
 * Anime4K version: v2.1
 * 
 * MIT License
 * 
 * © Anime no Sekai
...
/** KNOWN ISSUES
 * Serveral known issues are to be expected when using the upscaled version of Japan Terebi as they are still unfixed
 * - WebGL taking too much memory --> a memory cleanup needs to be done and the script needs to be tested against memory leaks and unnecessary allocation
 * - Safari returns a Security Error and doesn't want to show up anything because of the CORS policies
 * - Performance issues
 * - No parameter
...
const boldFactor = 8; // 0.0001 to 8 (default: 6)
const blurFactor = 0.0001; // 0.0001 to 8 (default: 2)
/** why using the max for the boldFactor and the min for the blurFactor?
 * For me, Anime4K smoothen and blurs the frames for real-life videos enough
 * 
 */
...
window.addEventListener("load", function () {
    ...
    videoPlayer.addEventListener('loadedmetadata', function () {
        ...
        scaler.inputVideo(videoPlayer);
        scaler.resize(upscaleFactor);
    }, true);
