...
async function defineEvents() {
    ...
    document.getElementById("debugPanelOpener").addEventListener("click", openDebugPanel)
    document.getElementById("debugPanelCloser").addEventListener("click", closeDebugPanel)
    document.getElementById("debugHeader").addEventListener("mousedown", debugHeaderDrag)
